    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className={`${priorityBgColors[request.priority]} border-2`}>
            ...
            <CardContent className="pt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-lg font-medium text-teal-900 dark:text-teal-100">{request.hostel?.name}</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-lg font-medium text-teal-900 dark:text-teal-100">
                    Block {request.room?.block} - Room {request.room?.room_number}
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          {request.assigned_staff && (
            <Card className="bg-gradient-to-br from-violet-50 to-fuchsia-50 dark:from-violet-950 dark:to-fuchsia-950 border-2 border-violet-200 dark:border-violet-800">
              <CardHeader className="border-b border-violet-200 dark:border-violet-800">
                <div className="flex items-center gap-2">
                  <UserCog className="h-5 w-5 text-violet-600 dark:text-violet-400" />
                  <CardTitle className="text-violet-900 dark:text-violet-100">Assigned Staff</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="pt-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {request.resolution_notes && (
            <Card className={`${statusBgColors[request.status]} border-2`}>
              <CardHeader className="border-b">
                <div className="flex items-center gap-2">
        ...
        <Card className="border-2 h-fit">
          ...
          <CardContent className="pt-6 space-y-4">
            ...
            <Button
              ...
              disabled={!status || updateRequestMutation.isPending}
            >
              Update Status
            </Button>
          </CardContent>
