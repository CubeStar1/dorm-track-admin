  ...
  return (
    <section className="py-20 sm:py-24 lg:py-32">
      ...
      >
        ...
        <span> ✨ Revolutionizing Hostel Management</span>
      ...
      >
        <h1 className="mx-auto max-w-4xl text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
          Your Complete {" "}
          <span className="bg-gradient-to-r from-[#38bdf8] via-[#2dd4bf] to-[#0070F3] bg-clip-text text-transparent">Hostel Management</span>{" "}
          Solution
        </h1>
        <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-muted-foreground sm:mt-8">
          DormTrack brings a 360° digital solution to hostel life with automated room allocation, complaint management, mess feedback, and community features.
        </p>
      ...
      >
        <div className="relative rounded-2xl bg-gradient-to-b from-muted/50 to-muted p-2 ring-1 ring-foreground/10 backdrop-blur-3xl dark:from-muted/30 dark:to-background/80">
          <Image
            src="/dormtrack-admin-rooms.png"
            alt="DormTrack Dashboard"
            width={1200}
            height={800}
            quality={100}
